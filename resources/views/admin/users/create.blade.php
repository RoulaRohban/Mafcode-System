        ...
        <div class="col-lg-12">
            ...
            <div class="card card-custom card-stretch gutter-b">
                ...
                <div class="card-header border-0">
                    <h3 class="card-title font-weight-bolder text-dark">@lang('admin.create') @lang('users.single')</h3>

                </div>
                <form class="kt-form" enctype="multipart/form-data" method="POST" action="{{ route('admin.users.store') }}" id="main-form">
                @csrf
                <!--end::Header-->
                    <!--begin::Body-->
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md">
                                <label for="password_confirmation"
                                       class="form-control-label">@lang('users.password_confirmation')</label>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md">
                                ...
                                <select name="active" id="active" class="form-control">
                                    <option value="yes">@lang('users.yes')</option>
                                    <option value="no">@lang('users.no')</option>
                                </select>
                            </div>
                            <div class="form-group col-md">
...
{{--                            <div class="form-group col-md">--}}
{{--                                <label for="image" class="form-control-label">@lang('users.image')</label>--}}
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md d-none" id="city">
                                ...
                                <select name="city_id" id="city_id" onchange="getRegions('region')" class="form-control">
                                    <option value="">@lang('users.select_city')</option>
                            ...
                            <div class="form-group col-md d-none" id="region">
                                ...
                                <select name="region_id" id="region_id" class="form-control">
                                    <option value="">@lang('users.select_region')</option>
